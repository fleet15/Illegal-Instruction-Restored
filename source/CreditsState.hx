...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Retro',			'retro',			'Artist for Prowler, Fists and Charter Of Final Frontier',															'https://twitter.com/Retronsons',											'279ADC'],
			['JDogg',			'jdogg',			'Charter for Final Frontier',																						'https://www.youtube.com/@honored_jdogg7208/featured',						'279ADC'],
