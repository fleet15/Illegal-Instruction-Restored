...
function onCreatePost()
	...
	if chartingMode then
		...
		makeLuaText('defaultslabel', 'Default\'s: ' .. (defaultVert and 'Downscroll' or 'Upscroll') .. ' and ' .. (defaultHori and 'Middlescroll' or 'Sidescroll'), width, 40, 340)
		setTextSize('defaultslabel', 24)
		addLuaText('defaultslabel')

		-- Cool, shitty title
		makeLuaText('titlingthisshit', 'Current Scrolltypes', width, 80, 370)
		setTextSize('titlingthisshit', 34)
		addLuaText('titlingthisshit')

		-- Vertical Label
		makeLuaText('Vert', 'Downscroll: ' .. (Vertical and 'On' or 'Off'), width, 57, 400)
		setTextSize('Vert', 48)
		addLuaText('Vert')

		-- Horizontal Label
		makeLuaText('Hori', 'Middlescroll: ' .. (Horizontal and 'On' or 'Off'), width, 57, 450)
		setTextSize('Hori', 48)
		addLuaText('Hori')

		-- Section Label
		makeLuaText('sectionCheck', 'Section: ' .. (gfSection and 'Dancer' or mustHitSection and 'Player' or 'Opponent'), width, 57, 500)
